...
<Notation type="box" color="blue">
	Given an array of numbers and an integer k, return the k most frequent elements. You can return the
	answer in any order.
</Notation>
...
Output: [1,2]  # 1 appears three times, 2 appears twice
```

## Solution Approach

Let's solve this step by step using a hash map and heap:
