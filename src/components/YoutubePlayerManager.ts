...
class YouTubePlayerManager {
    ...
    private trackingIntervals: Map<string, number>;
    private trackedTimes: Set<number>;
    private vtrTime: number;
    private readyCallbacks: Map<string, (player: any) => void>;
    private volumeMuteState: boolean;
    private volumeControlElem: HTMLElement | null;
